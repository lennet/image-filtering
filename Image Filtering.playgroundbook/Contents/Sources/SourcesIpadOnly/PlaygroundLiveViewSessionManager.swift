...
public class PlaygroundLiveViewSessionManager {
    ...
    public func sendError(hint: String, solution: String) {
        let messageValue = PlaygroundValue.dictionary([Constants.errorKey: PlaygroundValue.boolean(true),
    ...
    public func sendPassMessage(message: String) {
        let messageValue = PlaygroundValue.dictionary([Constants.errorKey: PlaygroundValue.boolean(false),
